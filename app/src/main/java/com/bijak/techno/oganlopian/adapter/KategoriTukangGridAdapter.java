...
public class KategoriTukangGridAdapter extends BaseAdapter {
        private Context mContext;
        private final String[] string;
        private final int[] Imageid;
        private final String[] kategoriid;

        public KategoriTukangGridAdapter(Context c,String[] string,int[] Imageid,String[] kategoriid ) {
            mContext = c;
            ...
            if (convertView == null) {
                ...
                imageView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(mContext, TukangbookingActivity.class);
